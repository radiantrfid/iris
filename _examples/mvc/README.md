...
![](https://github.com/radiantrfid/iris/raw/master/_examples/mvc/web_mvc_diagram.png)
...
where [mvc.Result](https://github.com/radiantrfid/iris/blob/master/mvc/func_result.go) is an interface which contains only that function: `Dispatch(ctx iris.Context)`.
...
Folder structure guidelines can be found at the [_examples/#structuring](https://github.com/radiantrfid/iris/tree/master/_examples/#structuring) section.