...
This folder provides easy to understand code snippets on how to get started with [iris](https://github.com/radiantrfid/iris/) micro web framework.
...
2. Install Iris: `go get -u github.com/radiantrfid/iris/`
